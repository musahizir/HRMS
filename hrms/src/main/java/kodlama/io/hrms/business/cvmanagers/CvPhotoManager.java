...
public class CvPhotoManager implements CvPhotoService {
	...
	@Override
	public DataResult<List<CvPhoto>> getAllByCandidateId(int candidateId) {
		
		return new SuccessDataResult<List<CvPhoto>>(this.cvPhotoDao.getAllByCandidateId(candidateId), "Fotoğraflar getirildi");
	}
